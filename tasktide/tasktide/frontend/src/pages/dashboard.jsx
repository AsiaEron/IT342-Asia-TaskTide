...
export default function Dashboard({ userId: userIdProp }) {
  ...
  const saveTask = async (e) => {
    ...
    const payload = {
      ...
      time_completed: isCompletedStatus(form.status) ? (editingTask?.time_completed ?? nowIso) : null,
  ...
  return (
    <div className="dashboard-page">
      <header className="top-nav">
        <div className="left">
          <span className="logo-text">HabitCanvas</span>
        </div>
        ...
        <div className="nav-center">
          ...
          <a href="/timer" className="nav-btn">
            <i className="fa fa-stopwatch" /> Timer
          </a>
          <a href="/calendar" className="nav-btn">
        ...
        <div className="task-list">
          <div id="active-tasks">
            {activeTasks.map((task) => (
              <TaskCard key={task.id} task={task} onEdit={openEditModal} onDelete={deleteTask} />
            ))}
          </div>
